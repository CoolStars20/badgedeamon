% Example Jinja 2 template for a confernece badge

% ``data'' is a row fomr your sql table with all the fields, e.g.
 ...
 {% endif %}
    ...
    {% if data['role'] %}
     \begin{minipage}[t][0.6in][c]{4.2in}
       \begin{tcolorbox}[width=0.98\textwidth,colback={{'{'}}{{data['rolecolor']}}{{'}'}},colupper=white]
           \centering
           {\bf \huge {{data['role']}} }
         \end{tcolorbox}
       \end{minipage}
